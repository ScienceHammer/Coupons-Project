...
public class AdminService extends ClientService {
	 ...
	 * 
	 */
	public Company addCompany(Company company, MultipartFile multiPartImage) throws CouponsSystemException {
		...
		if (multiPartImage != null) {
			String imagePath = storageService.storeFile(multiPartImage, "company_" + company.getId() + ".jpeg");
	 ...
	 *
	 */
	public Company updateCompany(Company company, MultipartFile multiPartImage) throws CouponsSystemException {
		if (company == null) {
		...
		if (multiPartImage != null) {
			String imagePath = storageService.storeFile(multiPartImage, "company_" + dbCompany.getId() + ".jpeg");
			dbCompany.setImage(imagePath);
		}
		return dbCompany;
	}
	...
	public Company deleteCompany(int companyID) throws CouponsSystemException {
		...
		storageService.deleteFile("company_" + companyID + ".jpeg");
		return company;
	}
	 ...
	 * 
	 */
	public Customer addCustomer(Customer customer, MultipartFile multiPartImage) throws CouponsSystemException {
		...
		;
		if (multiPartImage != null) {
			String imagePath = storageService.storeFile(multiPartImage, "customer_" + dbCustomer.getId() + ".jpeg");
			dbCustomer.setImage(imagePath);
		}
		return dbCustomer;
	 ...
	 * 
	 */
	public Customer updateCustomer(Customer customer, MultipartFile multiPartImage) throws CouponsSystemException {
		if (customer == null) {
	...
	public Customer deleteCustomer(int customerID) throws CouponsSystemException {
		...
		storageService.deleteFile("customer_" + customerID + ".jpeg");
		return customer;
	}
