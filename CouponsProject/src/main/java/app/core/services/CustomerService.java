...
public class CustomerService extends ClientService {
	...
	/**
	 * Getting all customer coupons by category.
	 * 
	 * @param category
	 * @return List<coupon>
	 * 
	...
	/**
	 * Getting all customer coupons by limiting upper price.
	 * 
	 * @param maxPrice
	 * @return List<coupon>
	 * 
	...
	/**
	 * Getting all customer coupons by limiting upper price and category.
	 * 
	 * @param maxPrice
	 * @param category
	 * @return List<coupon>
	...
	/**
	 * Getting all not customer coupons.
	 * 
	 * @return List<coupon>
	 * 
	 */
	...
	/**
	 * Getting all not customer coupons by category.
	 * 
	 * @param category
	 * @return List<coupon>
	 * @throws CouponsSystemException 
	...
	/**
	 * Getting all not customer coupons by limiting upper price.
	 * 
	 * @param maxPrice
	 * @return List<coupon>
	 * @throws CouponsSystemException 
	...
	/**
	 * Getting all not customer coupons by limiting upper price and category.
	 * 
	 * @param maxPrice
	 * @param category
	 * @return List<coupon>
